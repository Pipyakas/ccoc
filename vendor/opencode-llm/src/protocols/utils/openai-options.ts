...
// ccoc routes to OpenCode providers whose catalogs declare efforts up to "max"
// (e.g. deepseek-v4-flash low/high/max, gpt-5.6-luna .../max). Upstream the
// real OpenAI API does not accept "max", but these providers do; keep it in the
// set and let the provider validate. ccoc patch: do not drop on vendor refresh.
